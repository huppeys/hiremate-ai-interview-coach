        ...
        <div className="w-full">
            ...
            {!recording ? (
              <>
                <button
                  ...
                  className="w-16 h-16 rounded-full bg-teal-700 hover:bg-teal-800 text-white text-2xl flex items-center justify-center shadow-lg transition mb-3"
                >
                  🎙️
                </button>
          ...
          {value && (
            <div className="mt-3 p-3 bg-white border border-gray-200 rounded-lg">
              <p className="text-xs text-gray-500 mb-1">Recorded response:</p>
